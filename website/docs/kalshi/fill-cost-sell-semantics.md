...
verified: true
verified_by: "Reconciled against known trade outcomes in trades.jsonl. Previously broken P&L calculations (+$1.93 for a ~$0.01 trade) resolved correctly after applying complement transform. 2026-03-17."
severity: high
---
